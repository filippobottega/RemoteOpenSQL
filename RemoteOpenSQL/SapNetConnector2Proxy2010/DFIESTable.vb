...
Imports SAP.Connector
  ...
  Public Class DFIESTable 
    ...
    '@ <summary>
    '@ Copies the contents of the DFIESTable to the specified one-dimensional array starting at the specified index in the target array.
    '@ </summary>
